...
<template>
  <div>
    <section class="border-b border-stone-200 bg-gradient-to-b from-moss-50 to-white">
      <div class="mx-auto max-w-6xl px-4 py-16 text-center sm:px-6">
        <p class="mb-3 text-sm font-semibold uppercase tracking-widest text-moss-600">
          The global mycology community, on one calendar
        </p>
        <h1 class="mx-auto max-w-3xl font-display text-4xl font-bold text-stone-900 sm:text-5xl">
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-3">
          <NuxtLink
            to="/events"
            class="rounded-md bg-moss-700 px-5 py-2.5 text-sm font-semibold text-white hover:bg-moss-800"
          >
            Browse the calendar
          </NuxtLink>
          <NuxtLink
    ...
    <section class="mx-auto max-w-6xl px-4 py-12 sm:px-6">
      <div class="mb-6 flex items-end justify-between">
        <h2 class="font-display text-2xl font-semibold text-stone-900">Upcoming events</h2>
        <NuxtLink to="/events" class="text-sm font-medium text-moss-700 hover:underline">
          View full calendar →
        </NuxtLink>
      </div>
    ...
    <section class="border-t border-stone-200 bg-spore-50">
      <div class="mx-auto max-w-6xl px-4 py-12 text-center sm:px-6">
        <h2 class="font-display text-2xl font-semibold text-stone-900">Running a mycological event?</h2>
        <p class="mx-auto mt-2 max-w-xl text-stone-600">
